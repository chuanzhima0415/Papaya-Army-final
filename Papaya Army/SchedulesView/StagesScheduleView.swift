...
struct StagesScheduleView: View {
    ...
    var body: some View {
        ...
        .task {
            if let completedStages = await fileURL.loadDataFromFileManager() {
            ...
            if completedStages != self.completedStages {
                self.completedStages = completedStages
                await fileURL.saveDataToFileManager(completedStages)
            }
        }
    }
    ...
    StagesScheduleView(
        gpSchedule: GrandPrixSchedule(
            ...
            stageSchedule: StageSchedule(
                race: StartDate(date: "2025-03-16", time: "04:00:00Z"),
                qualifying: StartDate(date: "2025-03-15", time: "05:00:00Z"),
                practice1: StartDate(date: "2025-03-14", time: "01:30:00Z"),
                practice2: StartDate(date: "2025-03-14", time: "05:00:00Z"),
                practice3: StartDate(date: "2025-03-15", time: "01:30:00Z"),
                sprintQualifying: StartDate(date: nil, time: nil),
